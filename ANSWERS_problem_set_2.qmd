...
**Answer ---** This scatterplot has a positive correlation indicating that when there was a higher percentage of the mass that identified as liberal, it caused a higher percentage of women in state legislators in 2015. Although it's not a strong correlation, it's still indicative of a positive one. One could infer that there were more factors at play when roughly 25% to 28% of the mass public identified as liberal because there was a slight decline of the percentage of women in the state legislators.
