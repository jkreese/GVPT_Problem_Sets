...
::: {.callout-tip}
A small p-value is good! The p-value represents the probability that we would observe our statistic in a null world. Therefore, a smaller p-value indicates that there is a little support for the idea that the null hypothesis is true. We can; therefore, reject the null hypothesis. 
:::
...
::: {.callout-tip}
Because we are dealing with a sample mean, we have to use the t-statistic, not the z-score. 
:::
